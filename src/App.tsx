        ...
        <div className="modal-overlay" style={{ zIndex: 9998 }}>
          <div className="modal-panel" style={{ width: 380, textAlign: 'center' }}>
            ...
            <div style={{ margin: '16px 0', display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <span style={{ fontFamily: 'Share Tech Mono', fontSize: 10, color: 'var(--text3)' }}>OR</span>
              <div style={{ flex: 1, height: 1, background: 'var(--border)' }} />
            </div>
            <div style={{ display: 'flex', gap: 8 }}>
              <input type="text" value={localNameInput} placeholder="ニックネームで入る"
            ...
            <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: 'var(--text3)', marginTop: 10 }}>
              ※ Googleログインで別端末でも同じアカウントを使えます
            </div>
          </div>
        </div>
      )}
